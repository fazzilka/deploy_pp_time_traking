...
```
git clone https://gitflic.mtuci.ru/project/o-d-mitin-edu-mtuci-ru/tracking-task-completion-time.git
cd tracking-task-completion-time
...
cd existing_folder
git init
git remote add origin https://gitflic.mtuci.ru/project/o-d-mitin-edu-mtuci-ru/tracking-task-completion-time.git
git clone
